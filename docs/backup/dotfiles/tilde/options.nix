  ...
  options.myHome.dotfiles = {
    ...
    bash = {
      ...
      method = lib.mkOption {
        ...
        default = "copy";
        description = "Method to deploy bash configuration files";
      };
    ...
    zsh = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy zsh configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    vim = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy vim configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    fish = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy fish configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    nushell = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy nushell configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    starship = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy starship configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    alacritty = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy alacritty configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    ghostty = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy ghostty configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    rio = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy rio configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    git = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy git configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    lazygit = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy lazygit configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    tmux = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy tmux configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    zellij = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy zellij configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    rofi = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy rofi configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    sherlock = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy sherlock configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    rmpc = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy rmpc configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    yazi = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy yazi configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    qutebrowser = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy qutebrowser configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    obs-studio = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy obs-studio configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    vscode = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy vscode configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
    ...
    zed = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copy" "symlink" ];
        default = "copy";
        description = "Method to deploy zed configuration files";
      };
      useNixPackage = lib.mkOption {
        type = lib.types.bool;
        default = true;
