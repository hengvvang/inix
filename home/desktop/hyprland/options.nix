  ...
  options.myHome.desktop.hyprland = {
    ...
    packages = {
      ...
      method = lib.mkOption {
        ...
        default = "copyLink";
        description = "Method to deploy Hyprland configuration files: copyLink (file copyLink), realTime (symbolic link), or homeManager (Home Manager native)";
      };
    };
    ...
    swappy = {
      ...
      method = lib.mkOption {
        type = lib.types.enum [ "copyLink" "realTime" "homeManager" ];
        default = "copyLink";
        description = "Method to deploy Swappy configuration files: copyLink (file copyLink), realTime (symbolic link), or homeManager (Home Manager native)";
      };
      packageSource = lib.mkOption {
        type = lib.types.enum [ "none" "nixpkgs" "flake" ];
        default = "nixpkgs";
